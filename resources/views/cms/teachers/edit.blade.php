                ...
                <div class="card card-primary">
                    ...
                    <form id="create_form" role="form">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control cities" style="width: 100%;" id="cities">
                                        ...
                                        <option value="{{$city->id}}" @if ($city->id == $teacher->city_id) selected
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control schools" style="width: 100%;" id="schools">
                                        ...
                                        <option value="{{$school->id}}" @if ($school->id == $teacher->school_id)
                                            selected @endif>{{$school->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control gender" style="width: 100%;" id="gender">
                                        <option value="M" @if ($teacher->gender == 'M') selected @endif>ذكر</option>
                                        <option value="F" @if ($teacher->gender == 'F') selected @endif>أنثى</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="name">الإسم</label>
                                    <input type="text" id="name" class="form-control" id="name"
                                        value="{{$teacher->name}}" placeholder="أدخل الإسم ">
                                </div>
                                <div class="form-group">
                                    <label for="email">البريد الإلكتروني</label>
                                    <input type="email" id="email" class="form-control" id="email"
                                        value="{{$teacher->email}}" placeholder="أدخل البريد الإلكتروني ">
                                </div>
                                <div class="form-group">
                                    <label for="mobile">الجوال</label>
                                    <input type="tel" id="mobile" class="form-control" id="mobile"
                                        value="{{$teacher->mobile}}" placeholder="أدخل الجوال ">
                                </div>
                                <div class="form-group">
                                    <label for="birth_date">تاريخ الميلاد</label>
                                    <input id="birth_date" type="text" class="form-control"
                                        value="{{$teacher->birth_date}}" placeholder="أدخل تاريخ الميلاد">
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" @if ($teacher->active)
                        ...
                        <div class="card-footer">
                            <button type="button" onclick="performUpdate({{$teacher->id}})"
...
<script>
    ...
    function performUpdate(id){
        ...
        let redirectUrl = '{{ route('teachers.index') }}'
        update('/cms/admin/teachers/'+id, data, redirectUrl);
    }
</script>
@endsection